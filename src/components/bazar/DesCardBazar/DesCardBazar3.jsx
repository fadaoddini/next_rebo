...
import styles from './DesCardBazar3.module.css'; // وارد کردن استایل

const DesCardBazar3 = ({ href, coverImage, titleImage, characterImage, color }) => {
